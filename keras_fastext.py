...
@Author: Ruan Yang
@Date: 2018.11.14
@Purpose: keras examples/fastText
@本例是演示在 Keras中实现 fastText 分类算法
@测试数据集是 imdb 评论数据集
@在IMDB数据集上使用 单元和二元 嵌入的结果如下：
...
# 导入 keras 中的文本处理和模型构建模块

from keras.preprocessing import sequence
from keras.models import Sequential # 序贯模型
from keras.layers import Dense # 全连接层
from keras.layers import Embedding # 嵌入层作为NN的第一层
from keras.layers import GlobalAveragePooling1D # 池化层
from keras.datasets import imdb # 导入keras自带的数据集
